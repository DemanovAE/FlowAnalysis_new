...
#include "FemtoDstAnalyzer_QA.C"

int main(int argc, char** argv)
{
  TString inFileName, outFileName, WorkMode, Energy;
  TStopwatch timer;
  if (argc < 9)
  {
    std::cerr << "./FemtoDstAnalyzer_QA -i INPUTFILE -o OUTPUTFILE -m WORKMODE -g ENERGY" << std::endl;
    return 10;
  }
  ...
  FemtoDstAnalyzer_QA(inFileName.Data(),outFileName.Data(),WorkMode.Data(),Energy.Atoi());
